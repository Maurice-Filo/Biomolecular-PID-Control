...
Gains.K_P  = 0; Gains.K_I = 3; Gains.K_D = 0; Gains.omega_c = 10;
...
K_D_vector = linspace(0, K_D_Max, N);
...
RunTime = toc(RunTime);
save APIDF2_Deg_GeneExp_Variance_Sweep

else
load APIDF2_Deg_GeneExp_Variance_Sweep;
...
VarX2_Approximate = zeros(N_Refined,1);
for i = 1 : N_Refined
    Gains.K_D = K_D_vector_Refined(i);
    [Parameters, Feasible] = Gains2Params(Gains, Parameters, r, SupportingInput);
    VarX2_Approximate(i) = VarianceFormula_PID2_Deg(Parameters);
end
...
%% Set Figure 1
Figure1_Name = 'APIDF2_Deg_GeneExp_BioParameters';
...
%% Set Figure 2
Figure2_Name = 'APIDF2_Deg_GeneExp_StationaryVariance';
...
%% Set Figure 3
Figure3_Name = 'APIDF2_Deg_GeneExp_StochasticSimulations';
...
%% Set Figure 4
Figure4_Name = 'APIDF2_Deg_NominalSimulations_GeneExp';
...
Handle_Axis1 = axes(Handle_Figure1);
    Handle_Axis1.Position = [0.16, 0.1, 0.52, 0.82];
    Handle_Axis1.Box = 'on';
    ...
    colormap(Handle_Axis1, 'turbo');
        ...
        Handle_ColorBar.Position(1) = 0.78;
...
Handle_Annotation = annotation(Handle_Figure1, 'textbox', [0.75, 0.79, 0.1, 0.1]);
...
Handle_Axis2 = axes(Handle_Figure2);
    ...
    Handle_Axis2.XLabel.Position(2) = 7.9;
...
StationaryVariance_Smoothed = smoothdata(StationaryVariance, 'rlowess');
...
Handle_Axis31 = axes(Handle_Figure3);
    ...
    Handle_Axis31.YLim = [0, 30];
    Handle_Axis31.XLim = [0, 50];
for i = 1 : N_VeryFewTrajectories
    plot(Handle_Axis31, T_1{i}, Y_1{i}, 'Color', [DColor1, 0.1], 'LineWidth', LineWidth_Thin);
