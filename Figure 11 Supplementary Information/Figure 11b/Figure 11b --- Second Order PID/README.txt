#### Generate Supplementary Figure 11b (Second Order PID) ####
...
# Instructions
 - Open "APIDF2_Deg_Star_Variance.m" in MATLAB environment and set the variable "Load" to 0
 - Run "APIDF2_Deg_Star_Variance.m" to generate the simulated data saved as "APIDF2_Deg_Star_Variance_Sweep.mat"
 	> Expected run time: ~70-80 seconds
 - Set the variable "Load" to 1 and rerun "APIDF2_Deg_Star_Variance.m" to generate the figures.
