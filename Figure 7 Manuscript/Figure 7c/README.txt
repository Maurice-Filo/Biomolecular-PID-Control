...
# Instructions
 - Open "APIDF3_Deg_Star_PerformanceTracking.m" in MATLAB environment and set the variable "Load" to 0
 - Run "APIDF3_Deg_Star_PerformanceTracking.m" to generate the simulated data saved as "APIDF3_Deg_Star_PerformanceTracking_Sweep.mat"
 	> Expected run time with N = 30: ~15-25 seconds
 - Set the variable "Load" to 1 and rerun "PIDF3_Deg_Star_PerformanceTracking.m" to generate the figures.
