function Propensity = PropensityFunction_APIDF_NegativeZ2_Add(x, Parameters)
% Propensity Function for Cholesterol Network controlled by the APIDF
% controller with Additive inhibition, and Z2 as the negative actuation.
