function a = PropensityFunction_APIDF3_Deg_GeneExp(x, Parameters)
% Propensity for Network APIDF3_Deg_GeneExp
...
% 				    R9:		phi					--> 	 X_1				[k*Z_1]
% 				    R10:		 X_1					--> 	phi				[(delta*X_2 + delta_0*Z_3) * (X_1/kappa)^n / (1 + (X_1/kappa)^n )]
