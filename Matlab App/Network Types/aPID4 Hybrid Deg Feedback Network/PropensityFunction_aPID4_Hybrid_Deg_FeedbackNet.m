function a = PropensityFunction_aPID4_Hybrid_Deg_FeedbackNet(x, Parameters)
% Propensity for Network aPID4_Hybrid_Deg_FeedbackNet
...
% 				    R18:		phi					--> 	 X_1				[k*Z_1 + k_0*X_6]
% 				    R19:		 X_1					--> 	phi				[(alpha_1*Z_3 + alpha_2*X_6) * X_1/(X_1 + kappa_1)]
...
a = [ ...
		...
		eta_0*Z_3*Z_4; ...
		k*Z_1 + k_0*X_6; ...
		(alpha_1*Z_3 + alpha_2*X_6) * X_1/(X_1 + kappa_1); ...
		gamma_c*Z_1; ...
		gamma_c*Z_2; ...
		gamma_c*Z_3; ...
		gamma_c*Z_4 ...
