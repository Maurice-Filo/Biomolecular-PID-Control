...
Parameters.theta = 2;
Parameters.delta = 0;
Parameters.gamma_0 = 10; %3;
Parameters.delta_0 = 0;
Parameters.alpha_0 = 1;
Parameters.kappa_0 = 1;
Parameters.eta = 1e2;
...
%% Functions
StoichiometryMatrix = StoichiometryMatrix_APIDF3_Deg_GeneExp();
PropensityFunction = @PropensityFunction_APIDF3_Deg_GeneExp;
...
RunTime = toc(RunTime);
save APIDF3_Deg_GeneExp_Variance_Sweep

else
load APIDF3_Deg_GeneExp_Variance_Sweep;
...
%% Set Figure 1
Figure1_Name = 'APIDF3_Deg_GeneExp_BioParameters';
...
%% Set Figure 2
Figure2_Name = 'APIDF3_Deg_GeneExp_StationaryVariance';
...
%% Set Figure 3
Figure3_Name = 'APIDF3_Deg_GeneExp_StochasticSimulations';
...
%% Set Figure 4
Figure4_Name = 'APIDF3_Deg_NominalSimulations_GeneExp';
