#### Generate Supplementary Figure 11a (Third Order PID) ####
...
# Instructions
 - Open "APIDF3_Deg_GeneExp_Variance.m" in MATLAB environment and set the variable "Load" to 0
 - Run "APIDF3_Deg_GeneExp_Variance.m" to generate the simulated data saved as "APIDF3_Deg_GeneExp_Variance_Sweep.mat"
 	> Expected run time: ~80-90 seconds
 - Set the variable "Load" to 1 and rerun "APIDF3_Deg_GeneExp_Variance.m" to generate the figures.
