#### Generate Supplementary Figure 11b (Fourth Order PID) ####
...
# Instructions
 - Open "APIDF4_Deg_Star_Variance.m" in MATLAB environment and set the variable "Load" to 0
 - Run "APIDF4_Deg_Star_Variance.m" to generate the simulated data saved as "APIDF3_Deg_Star_Variance_Sweep.mat"
 	> Expected run time: ~160-170 seconds
 - Set the variable "Load" to 1 and rerun "APIDF4_Deg_Star_Variance.m" to generate the figures.
