...
Parameters.gamma_0 = 0.5;
Parameters.n = 1;
Parameters.n_0 = 1;
Parameters.delta_c = 0;
Parameters.delta = 0;
Parameters.delta_0 = 0;
...
Gains2Params = @APIDF3_Deg_Gains2Params;
OutputIndex = 6;

%% Swept K_D 
IC = zeros(9,1);
Gains = Params2Gains(Parameters, SupportingInput);
K_D_vector = linspace(0, 5, N);
...
clear ans MeanY_Iteration VarY_Iteration  FinalDistribution_Iteration iter

RunTime = toc(RunTime);
save APIDF3_Deg_Star_Variance_Sweep

else
load APIDF3_Deg_Star_Variance_Sweep;
...
delta_0_vector = zeros(N_Refined,1);
for i = 1 : N_Refined
    Gains.K_D = K_D_vector_Refined(i);
    [Parameters, Feasible] = Gains2Params(Gains, Parameters, r, SupportingInput);
    delta_vector(i) = Parameters.delta;
    delta_0_vector(i) = Parameters.delta_0;
end
...
%% Set Figure 1
Figure1_Name = 'APIDF3_Deg_Star_BioParameters';
...
%% Set Figure 2
Figure2_Name = 'APIDF3_Deg_Star_StationaryVariance';
...
%% Set Figure 3
Figure3_Name = 'APIDF3_Deg_Star_StochasticSimulations';
...
Handle_Axis1 = axes(Handle_Figure1);
    ...
    Handle_Axis1.XLim = [delta_0_vector(1), delta_0_vector(end)];
    Handle_Axis1.YLim = [delta_vector(1), delta_vector(end)];
...
scatter(Handle_Axis1, delta_0_vector, delta_vector, MarkerSize*3, linspace(K_D_vector_Refined(1), K_D_vector_Refined(N_Refined), N_Refined), 'filled');
plot(Handle_Axis1, Parameters_Nominal_1.delta_0, Parameters_Nominal_1.delta, 'Marker', 'o', 'MarkerSize', MarkerSize, 'Color', 'k', 'LineStyle', 'none', 'MarkerFaceColor', DColor1);
plot(Handle_Axis1, Parameters_Nominal_2.delta_0, Parameters_Nominal_2.delta, 'Marker', 'o', 'MarkerSize', MarkerSize, 'Color', 'k', 'LineStyle', 'none', 'MarkerFaceColor', DColor2);
plot(Handle_Axis1, Parameters_Nominal_3.delta_0, Parameters_Nominal_3.delta, 'Marker', 'o', 'MarkerSize', MarkerSize, 'Color', 'k', 'LineStyle', 'none', 'MarkerFaceColor', DColor3);
plot(Handle_Axis1, Parameters_Nominal_4.delta_0, Parameters_Nominal_4.delta, 'Marker', 'o', 'MarkerSize', MarkerSize, 'Color', 'k', 'LineStyle', 'none', 'MarkerFaceColor', DColor4);
