#### Generate Supplementary Figure 11b (Third Order PID) ####
...
# Instructions
 - Open "APIDF3_Deg_Star_Variance.m" in MATLAB environment and set the variable "Load" to 0
 - Run "APIDF3_Deg_Star_Variance.m" to generate the simulated data saved as "APIDF3_Deg_Star_Variance_Sweep.mat"
 	> Expected run time: ~110-120 seconds
 - Set the variable "Load" to 1 and rerun "APIDF3_Deg_Star_Variance.m" to generate the figures.
