function Propensity = PropensityFunction_AIF_NegativeZ2(x, Parameters)
% Propensity Function for Cholesterol Network Controlled by the AIF
% controller with Z2 as a negative actuator control species.
%% Parameters
